              ...
              >
                ...
                <div className="mt-auto flex items-center gap-2 pt-1">
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-3.5 py-2.5 rounded-lg text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors cursor-pointer"
                  >
                    <span>자세히 보기</span>
